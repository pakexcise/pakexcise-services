    ...
    <footer className="border-t bg-muted/30">
      <div className="container-site grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-3 sm:col-span-2 lg:col-span-1">
          <p className="text-lg font-semibold text-primary">{siteConfig.name}</p>
          <p className="text-sm text-muted-foreground">{t("description")}</p>
          <p className="rounded-md border border-secondary/30 bg-secondary/10 px-3 py-2 text-xs font-medium text-secondary-foreground">
            {t("privateNotice")}
          </p>
        </div>

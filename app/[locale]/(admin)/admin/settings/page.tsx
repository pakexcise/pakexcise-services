...
async function buildLabels(
  ...
  return {
    ...
    business: {
      ...
      businessEmail: t("settingsPanel.business.businessEmail"),
      phoneNumber: t("settingsPanel.business.phoneNumber"),
      whatsappNumber: t("settingsPanel.business.whatsappNumber"),
      whatsappDefaultMessage: t("settingsPanel.business.whatsappDefaultMessage"),
      businessHoursEn: t("settingsPanel.business.businessHoursEn"),
      businessHoursUr: t("settingsPanel.business.businessHoursUr"),
      addressEn: t("settingsPanel.business.addressEn"),
      addressUr: t("settingsPanel.business.addressUr"),
      disclaimerEn: t("settingsPanel.business.disclaimerEn"),
      disclaimerUr: t("settingsPanel.business.disclaimerUr"),
    },
    payment: {

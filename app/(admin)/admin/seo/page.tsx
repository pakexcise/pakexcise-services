    ...
    <div className="space-y-6">
      ...
      <SeoCsvPanel
        ...
        labels={{
          ...
          clearPreview: t("csv.clearPreview"),
          ...
          statsSkipped: t("csv.statsSkipped"),
          statsConflicts: t("csv.statsConflicts"),
          statsMissing: t("csv.statsMissing"),
          statsDuplicates: t("csv.statsDuplicates"),

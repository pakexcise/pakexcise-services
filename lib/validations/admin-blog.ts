...
const blogContentFaqSchema = z.object({
  ...
  questionUr: z.string().trim().max(500).optional().default(""),
  answerEn: z.string().trim().min(2).max(10000),
  answerUr: z.string().trim().max(10000).optional().default(""),
});
...
const blogExtendedFieldsSchema = z.object({
  ...
  featuredImageTitleUr: z.string().trim().max(200).optional().nullable(),
  featuredImageAltEn: z.string().trim().max(300).optional().nullable(),
  featuredImageAltUr: z.string().trim().max(300).optional().nullable(),
  featuredImageCaptionEn: z.string().trim().max(1000).optional().nullable(),
  featuredImageCaptionUr: z.string().trim().max(1000).optional().nullable(),
  ...
  ctaTitleUr: z.string().trim().max(200).optional().nullable(),
  ctaDescriptionEn: z.string().trim().max(2000).optional().nullable(),
  ctaDescriptionUr: z.string().trim().max(2000).optional().nullable(),
  ctaWhatsappLabelEn: z.string().trim().max(120).optional().nullable(),
  ctaWhatsappLabelUr: z.string().trim().max(120).optional().nullable(),
  ctaRequestLabelEn: z.string().trim().max(120).optional().nullable(),
  ctaRequestLabelUr: z.string().trim().max(120).optional().nullable(),
  ctaAccountLabelEn: z.string().trim().max(120).optional().nullable(),
  ctaAccountLabelUr: z.string().trim().max(120).optional().nullable(),
});
